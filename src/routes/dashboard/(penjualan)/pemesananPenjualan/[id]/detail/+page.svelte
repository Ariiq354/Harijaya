...
<div class="flex flex-col gap-4">
  ...
  <div class="flex items-center justify-between">
    <div class="flex flex-col gap-1">
      <h1 class="text-3xl font-bold">Detail Pemesanan Penjualan</h1>
    </div>
    <Button
      variant="outline"
      ...
      <div class="w-full">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div class="flex w-full flex-col gap-2 py-2">
            ...
            <Input disabled value={data.data.noPenjualan} />
          </div>
          <div class="flex w-full flex-col gap-2 py-2">
            <Label>Tanggal</Label>
          ...
          <Table.Body>
            {#each data.data.produk as item, i (item)}
              ...
              <Table.Row>
                ...
                <Table.Cell>
                  <Input disabled value={barang?.name} />
                </Table.Cell>
                <Table.Cell>
                  {#if harga}
                    {Math.round(harga)}
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div class="flex flex-col gap-2">
            ...
            <div class="flex w-full justify-between">
              <div>Pembulatan:</div>
              <Input class="w-fit" type="number" disabled value={data.data.pembulatan} />
            </div>
            <div class="flex w-full justify-between">
              <div>Grand Total:</div>
              <div>
