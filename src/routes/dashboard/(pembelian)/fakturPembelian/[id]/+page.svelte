<script lang="ts">
  ...
  $: $formData.total =
    (data.pemesananPembelian?.total as number) +
          ...
          <div>
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div class="flex w-full flex-col gap-2 py-2">
                ...
                <Input readonly value={data.pemesananPembelian?.supplier?.namaBank} />
              </div>
              <div class="flex w-full flex-col gap-2 py-2">
                <Label>No. Rekening</Label>
                <Input readonly value={data.pemesananPembelian?.supplier?.noRekening} />
              </div>
            </div>
            <div class="flex w-full flex-col gap-2 py-2">
              <Label>Atas Nama</Label>
              <Input readonly value={data.pemesananPembelian?.supplier?.atasNama} />
            </div>
          </div>
